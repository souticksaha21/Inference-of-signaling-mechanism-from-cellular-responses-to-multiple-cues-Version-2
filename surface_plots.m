...
figure(1); clf;
[s1,s2] = meshgrid(0:.5:10);
mreg=(s1.^2-2*s1.*(s2-1)+(s2+1).^2+4).^0.5;
...
s11=10;
s21=0;
dm1=(1/12)*(s11^2-2*s11*(s21-1)+(s21+1)^2+4)^0.5;
s12=0;
s22=10;
dm2=(1/12)*(s12^2-2*s12*(s22-1)+(s22+1)^2+4)^0.5;
s13=10;
s23=10;
dm3=(1/12)*(s13^2-2*s13*(s23-1)+(s23+1)^2+4)^0.5;
